          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`border rounded-lg w-full text-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-red-300 focus:border-red-500 transition-all duration-200 ${errors.firstName ? "border-red-500" : "border-gray-300"}`}
                />
                {errors.firstName && (
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`border rounded-lg w-full text-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-red-300 focus:border-red-500 transition-all duration-200 ${errors.lastName ? "border-red-500" : "border-gray-300"}`}
                />
                {errors.lastName && (
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`border rounded-lg w-full text-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-red-300 focus:border-red-500 transition-all duration-200 ${errors.email ? "border-red-500" : "border-gray-300"}`}
              />
              {errors.email && (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`border rounded-lg w-full text-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-red-300 focus:border-red-500 transition-all duration-200 ${errors.password ? "border-red-500" : "border-gray-300"}`}
                />
                <Button
                  type="button"
                  variant="ghost"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`border rounded-lg w-full text-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-red-300 focus:border-red-500 transition-all duration-200 ${errors.confirmPassword ? "border-red-500" : "border-gray-300"}`}
                />
                <Button
                  type="button"
                  variant="ghost"
      ...
      <div className="hidden md:flex w-full md:w-1/2 p-12 lg:p-16 flex-col justify-between text-white relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6 max-w-md mx-auto flex flex-col justify-center h-full">
          ...
          <div className="relative pl-10">
            <Rocket className="absolute left-0 top-0 h-8 w-8 text-blue-300 drop-shadow" />
          ...
          <div className="mt-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <span className="text-base text-white">Microsoft</span>
              </div>
              <div className="flex items-center gap-4">
                <ClipboardList className="h-8 w-8 text-white" />
                <span className="text-base text-white">Asana</span>
              </div>
              <div className="flex items-center gap-4">
                <Users className="h-8 w-8 text-white" />
                <span className="text-base text-white">Jira</span>
              </div>
              <div className="flex items-center gap-4">
                <Code className="h-8 w-8 text-white" />
                <span className="text-base text-white">Slack</span>
              </div>
              <div className="flex items-center gap-4">
                <Cloud className="h-8 w-8 text-white" />
                <span className="text-base text-white">Dropbox</span>
              </div>
              <div className="flex items-center gap-4">
                <HardDrive className="h-8 w-8 text-white" />
                <span className="text-base text-white">Atlassian</span>
              </div>
              <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-base text-white">GitLab</span>
              </div>
            </div>
          </div>
        </div>
